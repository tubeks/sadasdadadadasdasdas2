...
📋 <b>Правила чата</b>
Запрещено.
1. спам, реклама, ЛГБТ, экстремизм, политика, религия, контент 18+, слив личных данных любого рода
2. оскорбления родителей и родственников.
важно. администрация на свое усмотрение выбирает срок наказаний за нарушение правил.
"""
